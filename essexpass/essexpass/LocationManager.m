...
- (void)startMonitoringLocation {
    ...
    _anotherLocationManager.activityType = CLActivityTypeOther;
...
#pragma mark - sent Location to server
- (void)InsertLatLong
{
//    NSString *plistName = [NSString stringWithFormat:@"LocationArray.plist"];
//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
...
//    NSString *fullPath = [NSString stringWithFormat:@"%@/%@", docDir, plistName];
    ...
    NSMutableDictionary *jsondata=[NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithFormat:@"%f",self.myLocation.latitude],@"latitude",
                                   [NSString stringWithFormat:@"%f",self.myLocation.longitude],@"longitude",
                                   [userDetail objectForKey:@"email"],@"userEmail",
                                   dateString,@"createDate",nil];
    //NSLog(@"%@",jsondata);
    AFHTTPRequestOperationManager *manager=[[AFHTTPRequestOperationManager alloc]init];
    [manager POST:UPDATELOCATION parameters:jsondata
